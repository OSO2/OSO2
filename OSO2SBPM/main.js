...
var googleAnalytics = googleAnalyticsService.getTracker('UA-66340963-1');
...
$(document).ready(function () {
    ...
    chrome.hid.onDeviceAdded.addListener(
        function(device){
            ...
            if(mHidDeviceId){
                console.log('HID Device added: ' + mHidDeviceId);
                setTimeout(hidStart, 800);
            }
        });
    chrome.hid.onDeviceRemoved.addListener(
        function(deviceId){
            console.log('USB HID removed');
